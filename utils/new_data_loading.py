...
class OverlapDataset(Dataset):
    def __init__(self, dataset_dir, scale: float = 1.0) -> None:
        ...
        for scene in os.listdir(dataset_dir):
            ...
            number_of_frame = 15
            if scene == "scene_dynamic_cam_01":
                number_of_frame = 10
            
            for i in range(number_of_frame):
                list_frame = []
                if cam1:
                    list_frame.append(os.path.join(dataset_dir, scene, 'CAM1', 'frame'  , f'frame{i}.png'))
                ...
                if cam2:
                    list_frame.append(os.path.join(dataset_dir, scene, 'CAM2', 'frame'  , f'frame{i}.png'))
                ...
                if cam3:
                    list_frame.append(os.path.join(dataset_dir, scene, 'CAM3', 'frame'  , f'frame{i}.png'))
                ...
                if cam4:
                    list_frame.append(os.path.join(dataset_dir, scene, 'CAM4', 'frame'  , f'frame{i}.png'))
